		...
		<article>
			...
			<form action="joinPro.jsp" id="join" name="fr" method="post" onsubmit="return check()">
				<fieldset>
					...
					<input type="button" value="아이디중복검사" class="dup" onclick="idCheck()"><br>
				...
				<fieldset>
					...
					<label>우편번호</label><input type="text" id="zip" name="zip">
					<input type="button" class="dup" value="우편번호 찾기" onclick="execDaumPostcode()"><br>
					<label>주소</label><input type="text" id="addr1" name="addr1" style="width:300px;"><br>
					<label>상세주소</label><input type="text" id="addr2" name="addr2" style="width:300px;"><br>
